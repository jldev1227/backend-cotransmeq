 ...
 *
 * NOTA: para el formulario `personal` (Vinculación de Personal) NO se
 * requieren documentos adjuntos. El usuario puede enviar el formulario
 * con solo sus respuestas y firma. El Oficial de Cumplimiento puede
 * pedir los documentos después si lo requiere.
 */
export function getDocumentosRequeridos(
  ...
  if (tipoFormulario === 'personal') {
    // Vinculación de personal → adjuntos OPCIONALES.
    return []
  }
